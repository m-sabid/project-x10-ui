...
import swap from '../../../Image/Swap/swap.jpg'
import about from '../../../Image/Swap/about-swap.png'
                ...
                <div className='f-b-1 container'>
                    <div className='forex'>
                        <div className='forex-info'>
                            <p className='forex-p we'>WELCOME TO X-TEN</p>
                            <h1 className='f-c we'>Swap-Free Accounts</h1>
                            <p className='forex-p2 we'>We are promised to uphold our values.<br/>
                                We want you to trade with keeping yours.</p>
                        ...
                        <div>
                            <img className='f-img sw-img' src={swap} alt='' />
                        </div>
                    </div>
                </div>
                <div className='f-b-1 container'>
                    <div className='forex'>
                        <div>
                            <img className='st-mar-img' src={about} alt=''></img>
                        </div>
