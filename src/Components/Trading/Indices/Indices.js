...
import indices from '../../../Image/indices/indices.jpg'
import market from '../../../Image/indices/ind-market.png'
                ...
                <div className='f-b-1 container'>
                    <div className='forex'>
                        <div className='forex-info'>
                            ...
                            <h1 className='f-c'>Indices</h1>
                            <p className='forex-p2'>Trades CFDs on the world's most popular indices with ultra-fast execution.</p>
                        ...
                        <div>
                            <img className='f-img' src={indices} alt='' />
                        </div>
                    </div>
                </div>
                <div className='f-b-1 container'>
                    <div className='forex'>
                        ...
                        <div className='forex-info3'>
                            <h1 className='f-m-h'>About the<span className='f-m-c'> Indices Market</span></h1>
                            <p className='mt-4'>An index is a way to standardize and track the performance of an asset or set of securities.</p>
                            <p className='mt-3'>Indices are also used as benchmarks for assessing other economic data, such as inflation or general interest rate developments.</p>
                            <p className='mt-3'>Popular financial market indices include the S&P 500, which tracks the 500 largest publicly traded companies in the United States. Other leading indices traded in the United States include the Dow Jones Industrial Average and the NASDAQ.</p>
                            <p className='mt-3'>Indices from many other major markets are also actively traded, including DAX (Germany) and FTSE (UK).</p>
                        </div>
                    </div>
                </div>
            </div>
